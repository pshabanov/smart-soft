    ...
    <main class="py-6">
        <div class="wrapper pb-10">
			...
			C353.537,163.146,350.462,174.623,341.517,179.788z"/>
                    ...
                    <div class="ww-best__item">
                        <div class="ww-best__icon">
                            <svg fill="#000" width="800px" height="800px" viewBox="0 0 64 64" data-name="Material Expand" id="Material_Expand" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="ww-best__item">
                        <div class="ww-best__icon">
                            <svg fill="#000" height="800px" width="800px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
                                <g>
                                    <g>
                                        <path d="m289.7,76.1l55.3,47.8h-55.3v-47.8zm106.9,340.7c-11.3-5.68434e-14-20.5,9.1-20.5,20.4v23h-304.2v-408.4h176.9v92.4c0,11.3 9.2,20.4 20.5,20.4h106.9v122.4c0,11.3 9.2,20.4 20.5,20.4 11.3,0 20.5-9.1 20.5-20.4v-145.6c0-5.9-2.6-11.6-7.1-15.4l-127.4-110c-3.7-3.2-8.5-5-13.4-5h-217.8c-11.3,0-20.5,9.1-20.5,20.4v449.2c0,11.3 9.2,20.4 20.5,20.4h345.2c11.3,0 20.5-9.1 20.5-20.4v-43.4c-0.1-11.3-9.3-20.4-20.6-20.4z" fill="#444"/>
                                        <path d="m305.7,198.9h-162c-11.3,0-20.5,9.1-20.5,20.4s9.2,20.4 20.5,20.4h162.1c11.3,0 20.5-9.1 20.5-20.4s-9.3-20.4-20.6-20.4z" fill="#ff813d"/>
                                        <path d="m305.7,299.4h-162c-11.3,0-20.5,9.1-20.5,20.4 0,11.3 9.2,20.4 20.5,20.4h162.1c11.3,0 20.5-9.1 20.5-20.4-0.1-11.2-9.3-20.4-20.6-20.4z" fill="#ff813d"/>
                                        <path d="m480.9,317.5c-1-11.2-11-19.5-22.2-18.5-46.2,4.1-90.1,54.6-112.7,85.3l-13.3-15.1c-7.5-8.5-20.4-9.3-28.9-1.8-8.5,7.5-9.3,20.4-1.8,28.8l30.7,34.8c12,11.9 25.2,9.7 32.7-2.7 13.4-22.1 60.7-85.4 96.9-88.6 11.3-1.1 19.6-11 18.6-22.2z" fill="#ff813d"/>
                                    </g>
                                </g>
                            </svg>
                        </div>
                    ...
                    <div class="ww-best__item">
                        <div class="ww-best__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#ff813d" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <section class="target">
            <div class="wrapper">
                <div class="target__text">
                    ...
                    <div class="target__subtitle">Мы помогаем создавать удобные и эффективные инструменты учета и ведения бизнеса на базе продуктов 1С</div>
                </div>
